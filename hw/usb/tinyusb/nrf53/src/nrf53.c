...
{
    uint32_t enabled = nrf_usbreg_status_get(NRF_USBREGULATOR_S);

    if ((0 != (enabled & USBREG_USBREGSTATUS_VBUSDETECT_Msk)) &&
    ...
    if ((0 != (enabled & USBREG_USBREGSTATUS_OUTPUTRDY_Msk)) &&
